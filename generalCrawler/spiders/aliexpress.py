    ...
    def parse(self, response):
        try:
            ...
            if data:
                ...
                item['productId'] = self.product_id(data)
                item['productNoFound'] = False
                item['productUrl'] = f'https://www.aliexpress.com/item/{item["productId"]}.html'
                ...
                item['skuList'], item['skuIds'] = self.sku_price_list(data, item["productId"])
                item['skuPrice'] = 0
